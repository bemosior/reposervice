...
<xsl:stylesheet version="1.0"
  ...
  <xsl:variable name="PORT">${FEDORA_SERVER_PORT}</xsl:variable>
  ...
  <xsl:include href="${FEDORA_HOME}/gsearch/fgsconfigFinal/index/FgsIndex/islandora_transforms/DC_to_solr.xslt"/>
  <xsl:include href="${FEDORA_HOME}/gsearch/fgsconfigFinal/index/FgsIndex/islandora_transforms/RELS-EXT_to_solr.xslt"/>
  <xsl:include href="${FEDORA_HOME}/gsearch/fgsconfigFinal/index/FgsIndex/islandora_transforms/RELS-INT_to_solr.xslt"/>
  <xsl:include href="${FEDORA_HOME}/gsearch/fgsconfigFinal/index/FgsIndex/islandora_transforms/FOXML_properties_to_solr.xslt"/>
  <xsl:include href="${FEDORA_HOME}/gsearch/fgsconfigFinal/index/FgsIndex/islandora_transforms/datastream_id_to_solr.xslt"/>
  <!--<xsl:include href="${FEDORA_HOME}/gsearch/fgsconfigFinal/index/FgsIndex/islandora_transforms/MODS_to_solr.xslt"/>-->
  <xsl:include href="${FEDORA_HOME}/gsearch/fgsconfigFinal/index/FgsIndex/islandora_transforms/slurp_all_MODS_to_solr.xslt"/>
  <xsl:include href="${FEDORA_HOME}/gsearch/fgsconfigFinal/index/FgsIndex/islandora_transforms/EACCPF_to_solr.xslt"/>
  <xsl:include href="${FEDORA_HOME}/gsearch/fgsconfigFinal/index/FgsIndex/islandora_transforms/TEI_to_solr.xslt"/>
