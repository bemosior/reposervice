...
<xsl:for-each select="//fedora:isMemberOfCollection">
<field name="fedora.isMemberOfCollection">
<xsl:value-of select="text()"/>
</field>
</xsl:for-each>
<xsl:for-each select="//fedora:isMemberOfCollection/@rdf:resource">
<field name="fedora.isMemberOfCollection_rdf:resource">
<xsl:value-of select="."/>
</field>
</xsl:for-each>
<xsl:for-each select="//fedora-model:hasModel">
<field name="fedora-model.hasModel">
<xsl:value-of select="text()"/>
</field>
</xsl:for-each>
<xsl:for-each select="//fedora-model:hasModel/@rdf:resource">
<field name="fedora-model.hasModel_rdf:resource">
<xsl:value-of select="."/>
</field>
</xsl:for-each>
...
<field name="rdf.Description_rdf:about">
<xsl:value-of select="."/>
</field>
</xsl:for-each>
